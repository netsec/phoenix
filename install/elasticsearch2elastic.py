...
elasticServer = os.environ.get('ES_METRICS_CLUSTER_URL', 'http://DOCKER_ELASTIC_IP:9200')
...
elasticMonitoringCluster = os.environ.get('ES_METRICS_MONITORING_CLUSTER_URL', 'http://DOCKER_ELASTIC_IP:9200')
